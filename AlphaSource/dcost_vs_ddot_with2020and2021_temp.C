...
void dcost_vs_ddot_with2020and2021(TString tagTime="") {
    ...
    //incMeas.push_back("EJ200PVT-1X2P Sept. 2020");
    //incMeas.push_back("EJ200PVT-1X2P Dec. 2020");
    //incMeas.push_back("EJ200PVT-2X1P");
    //incMeas.push_back("EJ200PVT-2X1P Sept. 2020");
    //incMeas.push_back("EJ200PVT-2X1P Dec. 2020");
...
measurements.push_back(
    ...
    if (useGray) {
      ...
      allgraphs->SetMaximum(20.0*0.01*1000*1000);
      xmin = 5.e-1;
      xmax = 2.e4;
    }
    ...
    // Prepare the legend
    TLegend *legendA = new TLegend(0.4,0.12,0.75,0.35);
    ...
    canv->SaveAs("paperPlots/ver14/"+filename+".pdf");
}
