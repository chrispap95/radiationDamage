...
void annealing_curves() {
  ...
  incRod.push_back("EJ200PS_T1_2");
  incRod.push_back("EJ200PS_T1_3");
  incRod.push_back("EJ200PS_L7R");
  incRod.push_back("EJ200PS_L8R");
  incRod.push_back("EJ200PS_L9R");
  incRod.push_back("EJ200PS_L10R");
